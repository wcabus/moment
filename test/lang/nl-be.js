...
exports["lang:nl-be"] = {
    ...
    "from" : function (test) {
        ...
        test.equal(start.from(moment([2007, 1, 28]).add({s: 45}), true),  "een minuut",      "45 seconds = a minute");
        test.equal(start.from(moment([2007, 1, 28]).add({s: 89}), true),  "een minuut",      "89 seconds = a minute");
        ...
        test.equal(start.from(moment([2007, 1, 28]).add({m: 45}), true),  "een uur",       "45 minutes = an hour");
        test.equal(start.from(moment([2007, 1, 28]).add({m: 89}), true),  "een uur",       "89 minutes = an hour");
        ...
        test.equal(start.from(moment([2007, 1, 28]).add({d: 26}), true),  "een maand",       "26 days = a month");
        test.equal(start.from(moment([2007, 1, 28]).add({d: 30}), true),  "een maand",       "30 days = a month");
        test.equal(start.from(moment([2007, 1, 28]).add({d: 45}), true),  "een maand",       "45 days = a month");
        ...
        test.equal(start.from(moment([2007, 1, 28]).add({M: 1}), true),   "een maand",       "1 month = a month");
        ...
        test.equal(start.from(moment([2007, 1, 28]).add({d: 345}), true), "een jaar",        "345 days = a year");
        test.equal(start.from(moment([2007, 1, 28]).add({d: 547}), true), "een jaar",        "547 days = a year");
        test.equal(start.from(moment([2007, 1, 28]).add({d: 548}), true), "2 jaar",       "548 days = 2 years");
        test.equal(start.from(moment([2007, 1, 28]).add({y: 1}), true),   "een jaar",        "1 year = a year");
    ...
    "returns the name of the language" : function (test) {
        if (typeof module !== 'undefined' && module.exports) {
            test.equal(require('../../lang/nl-be'), 'nl-be', "module should export nl-be");
        }
